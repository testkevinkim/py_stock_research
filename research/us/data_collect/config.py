...
first_capture_time = "16:05:00" # 16:05:00
second_capture_time = "17:00:00" # 17:00:00
...
history_path = os.path.join(root_path, "{}us_bid_ask_collect_history.json".format("test_" if override else ""))
